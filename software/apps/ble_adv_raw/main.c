...
static simple_ble_config_t ble_config = {
        ...
        .adv_name          = "I am Cold", // used in advertisements if there is room 
...
int main(void) {
  ...
  // Start Advertising
  uint8_t ble_data[BLE_GAP_ADV_SET_DATA_SIZE_MAX] = {0x02, 0x01, 0x06, 0x0A, 0x09, 0x49, 0x20, 0x61, 0x6D, 0x20, 0x43, 0x6F, 0x6C, 0x64,
      0x02, 0x0A, 0x08};
